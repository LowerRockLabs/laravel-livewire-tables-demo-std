...
class UsersTable extends DataTableComponent
{
    ...
    public function filters(): array
    {
        return [
            ...
            // Should have both a Custom Label (Displaying Custom Label Blade) and Custom Pill blade (prefixes "CustomPills -")
            SelectFilter::make('E-mail Verified', 'email_verified_at')
                ...
                ->setFilterPillBlade('includes.customFilterPill')
                ->options([
                    '' => 'Any',
                    'yes' => 'Yes',
                    'no' => 'No',
                ...
                // Demonstrates that setting row/colspan/title does not override hiddenFromAll()
                ...
                // When filter is slidedown - should appear on row 2, and span 2 columns
                ...
                // When filter is slidedown - should appear on row 3, and span 2 columns
                ...
                // When filter is slidedown - should appear on row 2
                // Should have a Custom Label
    ...
    {
        return User::query()->with(['tags', 'parent.id:name']);
    }
